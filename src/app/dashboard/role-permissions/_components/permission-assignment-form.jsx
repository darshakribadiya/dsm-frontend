...
export function PermissionAssignmentForm({
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent className="flex flex-col w-[600px]">
        <SheetHeader>
        ...
        {/* Scrollable section */}
        <div className="flex-1 overflow-y-auto py-4 [&::-webkit-scrollbar]:hidden [scrollbar-width:none]">
          {loading ? (
                ...
                {allPermissions.map((permission) => (
                  <TableRow key={permission.id}>
                    <TableCell>
                      ...
                      >
                        {selectedPermissions.includes(permission.id) ? (
                          <Icon icon="mdi:assignment-turned-in" />
                        ) : (
